          ...
          <div class="navigation__body__row">
            ...
            <section class="navigation-menu__labels nav">
              ...
              <router-link
                class="nav__link"
                to="/about"
                :class="route === '/about' ? 'nav__link-active' : ''"
              >
                {{ $t("nav__link__1") }}</router-link
              >
              <a
                class="nav__link"
                style="cursor: pointer"
                :class="
                  route === '/accommodation' || route === '/restaurants'
                    ? 'nav__link-active'
                    : ''
                "
              >
              ...
              <router-link
                class="nav__link"
                to="/destination"
                :class="route === '/destination' ? 'nav__link-active' : ''"
                >{{ $t("nav__link__3") }}</router-link
              >
              <router-link
                class="nav__link"
                to="/opentv"
                :class="route === '/opentv' ? 'nav__link-active' : ''"
                >{{ $t("nav__link__4") }}</router-link
              >
              <a
                class="nav__link"
                style="cursor: pointer"
                :class="
                  route === '/photos' || route === '/videos' || route === '/360'
                    ? 'nav__link-active'
                    : ''
                "
              >
              ...
              <router-link
                class="nav__link"
                to="/contacts"
                :class="route === '/contacts' ? 'nav__link-active' : ''"
                >{{ $t("nav__link__5") }}</router-link
              >
            </section>
            <ThemeComponent />
            <LanguageComponent />
